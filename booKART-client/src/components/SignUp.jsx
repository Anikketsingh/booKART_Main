  ...
  const handleSignUp = (event) => {
    ...
    createUser(email, password)
      .then((userCredential) => {
        ...
        form.reset();  // Optionally reset the form after successful sign-up
      })
      .catch((error) => {
          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="divide-y divide-gray-200">
              <form onSubmit={handleSignUp} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <p>If you have an account, please <Link to="/login" className="text-purple-300 underline">Login</Link> here.</p>
                <div className="relative">
            ...
            <div className='flex w-full items-center flex-col mt-5 p-5 gap-4 '>
              <button onClick={handleReg} className='block text-white-700'><img src={googleLogo} alt="" className='w-12 p-2 inline-block'/>Login with Google</button>
            </div>
          </div>
        </div>
      </div>
